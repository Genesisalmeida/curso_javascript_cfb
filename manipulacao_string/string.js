...
// console.log(nome.indexOf('e')) //Indexof : você passa a strig e ele retorna a posição da primeira string passada"ne a primeira foi n",se você passar uma string  inexistente, ele retorna -1.
...
console.log(nome.split('e') )// Divide a string em um array, separando pelo caractere 'e'O método .split(separador) divide a string onde encontra o separador e retorna um array com as partes..
